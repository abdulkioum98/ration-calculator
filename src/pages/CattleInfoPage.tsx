...
export default function CattleInfoPage({ onSaveAndNext, initialData }: CattleInfoPageProps) {
  // Top category state: 'dairy' or 'fattening'
  ...
  const fetchNourishFeeds = async () => {
    ...
    try {
      ...
      console.error('Error fetching Nourish feeds:', err);
    }  finally {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      {/* 1. CATEGORY TOGGLE (Dairy vs Fattening) */}
      ...
      {category === 'dairy' ? (
        ...
        /* BLANK / COMING SOON FOR FATTENING */
        <div className="bg-white rounded-xl border border-dashed border-slate-300 p-12 text-center text-slate-500">
          <p className="text-lg font-bold text-slate-700">Fattening Ration Calculator</p>
